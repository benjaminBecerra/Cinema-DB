...
La misma fue un proyecto individual, en el cual se muestran películas y programas de televisión y su 
correspondiende informacion. Para eso, la web app,
consume la información de la API de The Movie Database (TMDB).

Se puede navegar y ver la informacion de las peliculas y programas, tambien se puede crear un usuario para poder agregar peliculas como Favoritas.
...
### ¡Otros proyectos! 👇
 ...
 - [Black Cat](https://github.com/benjaminBecerra/Black-Cat)
